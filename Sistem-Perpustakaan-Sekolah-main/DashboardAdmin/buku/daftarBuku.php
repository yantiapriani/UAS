...
$buku = queryReadData("SELECT * FROM tb_buku");
       ...
       <div class="card" style="width: 15rem;">
         ...
         <div class="card-body">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Id Buku : <?= $item["kodebuku"]; ?></li>
          </ul>
        <div class="card-body">
          <a class="btn btn-success" href="updateBuku.php?kodebukuReview=<?= $item["kodebuku"]; ?>" id="review">Edit</a>
          
          <a class="btn btn-danger" href="deleteBuku.php?kodebukuReview=<?= $item["kodebuku"]; ?>" onclick="return confirm('Yakin ingin menghapus data buku ? ');">Delete</a>
          </div>
        </div>
       <?php endforeach; ?>
       </div>
